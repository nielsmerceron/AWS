<html data-theme="light" lang="fr"></html>
<div class="navbar">
    <div class="navbar-start">
        <a class=" normal-case text-xl">To do list</a>
    </div>
    <div class="navbar-center secondary lg:flex">Welcome</div>
...
<div class="container py-10 px-10 mx-0 min-w-full grid place-items-center">
    ...
    <div class="container py-10 px-10 mx-0 min-w-full grid place-items-center">
        ...
        ordonner.
        <p>
            Nous avons plusieurs features qui pourront vous intéreresser tel que
            des rappels de tache,
        </p>
        <p>
